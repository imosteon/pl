...
document.onclick = function (e) {
  if (
    $(".components__popup").hasClass("show") &&
    !e.target.classList.contains("components__link")
  ) {
    if (!e.target.closest(".components__popup")) {
      $(".components__popup").removeClass("show");
    } else {
      console.log(e.target.closest(".components__popup"));
    }
  }
};
